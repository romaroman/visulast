...
class UserController:
    ...
    def artists_classic_eight(self, period=vars.PERIOD_OVERALL):
        return GeneralView.draw_classic_eight_chart(self.model.get_classic_eight_artists(period))
    ...
    def albums_classic_eight(self, period=vars.PERIOD_OVERALL):
        return GeneralView.draw_classic_eight_chart(self.model.get_classic_eight_albums(period))
...
class AlbumController:
    ...
    def tracks_bar_chart(self, title='tracks'):
